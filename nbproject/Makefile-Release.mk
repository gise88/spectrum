...
${OBJECTDIR}/ACacheManager.o: ACacheManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ACacheManager.o ACacheManager.cpp
...
${OBJECTDIR}/SpectrumChannelsDiskCache.o: SpectrumChannelsDiskCache.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpectrumChannelsDiskCache.o SpectrumChannelsDiskCache.cpp
...
${OBJECTDIR}/ACacheManager_nomain.o: ${OBJECTDIR}/ACacheManager.o ACacheManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ACacheManager_nomain.o ACacheManager.cpp;\
	else  \
...
${OBJECTDIR}/SpectrumChannelsDiskCache_nomain.o: ${OBJECTDIR}/SpectrumChannelsDiskCache.o SpectrumChannelsDiskCache.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpectrumChannelsDiskCache_nomain.o SpectrumChannelsDiskCache.cpp;\
	else  \
